...
- app product context は `data/app-product-context.json` に置き、スクリーンショットや planning file は `output/ios-page-screenshots/`, `output/app-store-screenshots/` のような出力フォルダへ整理する
